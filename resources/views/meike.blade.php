    ...
    <nav class="navbar navbar-light bg-light">
        <div class="container">
          <a class="navbar-brand" href="#">
            <img src="images/taurus.png" alt="" width="50" height="35">
          </a>
      ...
      <div class="container py-5 px-4">
          <div class="row">
              <div class="col-md-5 order-md-2">
                  <img class="img-fluid" src="images/foto meike.png" alt="main logo">
              </div>
              <div class="col-md-7 order-md-1">
                  <h1 class="mt-4 display-3"><b> Hello I'm Meike!!</b></h1>
                  <p class="fs-5 mt-3">I am someone who likes to learn new things and is 
                    stubborn of course because I am the last child. Has a story-telling nature but is introverted. 
                    And that's me.I am a taurus known as a very tough and persistent individual. They don't like rapid changes and prefer to have a structured routine. 
                    They are deeply attached to traditional values ​​and have a strong drive to create stability in their lives, be it in terms of finances, relationships, or careers.</p>
                  <div class="row">
                      <div class="d-flex flex-column flex-md-row">
                        <button type="button" class="btn btn-secondary">Introduction</button>
                      </div>
                  </div>
              </div>
          </div>
        ...
        <div class="row">
            <div class="col-lg-3 mb-5">
                <a href="#" class="logo text-decoration-none">
                    <div class="d-flex">
                        <img class="img-fluid" src="images/taurus.png" alt="Bootstrap Logo" style="width: 40px;">
                        <div class="fs-5 ms-2 text-black">Taurus</div>
                    </div>
                </a>
                <div class="mt-2 text-muted">
                    <small>a zodiac runs from April 20 to May 20. People born between these dates are considered to have the zodiac sign Taurus.<a href="#" class="text-black">Taurus Team</a> with the help of 
