...
<body>
    <div class="container m-5">
        ...
        <div class="list-group mt-4">
            <a href="<?php echo e(url('/meike')); ?>" class="list-group-item list-group-item-action">
               Personal Web 
            </a>
        </div>
...
<?php /**PATH C:\xampp\htdocs\basic-router\resources\views/routing.blade.php ENDPATH**/ ?>